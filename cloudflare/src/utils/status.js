export const ERR = {
  ...
  INVALID_INPUT: { code: 1008, message: "Username and password must be non-empty strings" },
  ...
  INVALID_ORDER_PAYLOAD: { code: 4006, message: "Invalid order payload" },
  INVALID_UID_HEX: { code: 4007, message: "Invalid UID Hex" },
  INVALID_ORDER_TYPE: { code: 4008, message: "Invalid order type" },
  ORDER_STEPS_REQUIRED: { code: 4009, message: "Sequence order requires saved steps before assignment" },
  INVALID_ORDER_STEPS_PAYLOAD: { code: 4010, message: "Invalid order steps payload" },
  ORDER_STEP_EDIT_FORBIDDEN: { code: 4011, message: "Order steps can only be edited before assignment" },
  SCAN_UID_MISMATCH: { code: 4012, message: "Scanned UID Hex does not match the required target" },
  SCAN_OUT_OF_ORDER: { code: 4013, message: "Scanned UID Hex is out of the required order" },
  SCAN_DUPLICATE: { code: 4014, message: "This sequence step has already been completed" },
  ORDER_SCAN_REQUIRED: { code: 4015, message: "This order must be completed by NFC scan" },
  DEPRECATED_COMPLETE_API: { code: 4016, message: "Manual completion API is deprecated; use /worker/orders/scan" },
  ORDER_PROGRESS_LOCKED: { code: 4017, message: "Sequence order progress prevents unassignment" },
  ORDER_TARGET_UID_REQUIRED: { code: 4018, message: "Standard order requires a target UID Hex" },
  ORDER_NEXT_STEP_MISSING: { code: 4019, message: "Next sequence step definition is missing" },
  ORDER_STEP_NOT_SUPPORTED: { code: 4020, message: "This order type does not support sequence steps" },
  INVALID_ORDER_ID: { code: 4021, message: "Invalid order id" },
  INVALID_WORKER_ID: { code: 4022, message: "Invalid worker id" },
...
export const INFO = {
  ...
  ORDER_STEPS_SAVED_SUCCESS: { code: 9012, message: "Order steps saved successfully" },
  ORDER_SCAN_SUCCESS: { code: 9013, message: "Order scan processed successfully" },
}
